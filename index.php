...
/*
DESARROLLADO POR: 
JESUS DAVID CASTAÑEDA QUINTERO
jedaplay@gmail.com
*/
...
<div id=icono_menu  style="float:left;border:solid 0px black">&nbsp;<img  src='img/menu.png' style="vertical-align:middle;width:32px;height:32px;border:solid 0px black;">&nbsp;</div>
